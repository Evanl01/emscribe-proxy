...
const EditTranscript = () => {
  ...
  useEffect(() => {
    auth.checkAuthAndRedirect(router);
  }, [router]);
  ...
  const addToUndoStack = (text) => {
    if (
      ...
      undoStack.current[undoStack.current.length - 1] !== text
    ) {
  ...
  const saveTranscript = async () => {
    ...
    const cc =
      chiefComplaint.trim() || EmScribeUtils.extractChiefComplaint(text);
    try {
        ...
        <header className="editor-header">
          <div className="header-content">
            ...
            <div className="header-actions">
              <button className="btn btn-primary" onClick={saveTranscript}>
                💾 Save
              </button>
          ...
          <div className="editor-sidebar">
            ...
            <div className="sidebar-section">
              ...
              <div className="stats-grid">
                ...
                <div className="stat-item">
                  <span className="stat-label">Est. Reading:</span>{" "}
            ...
            <div className="sidebar-section">
              ...
              <div className="formatting-tools">
                ...
                <button
                  className="btn btn-outline btn-small"
                  onClick={() => showMessage("Spell check coming soon", "info")}
                >
                  🔤 Spell Check
                </button>
                <button
                  className="btn btn-outline btn-small"
                  onClick={() =>
                    showMessage("Medical terms validation coming soon", "info")
                  }
                >
                  🏥 Medical Terms
                </button>
            ...
            <div className="sidebar-section">
              ...
              <div className="quick-actions">
                <button
                  className="btn btn-outline btn-small"
                  onClick={() => showMessage("Duplicate coming soon", "info")}
                >
                  📋 Duplicate
                </button>
                <button
                  className="btn btn-outline btn-small"
                  onClick={() => showMessage("Export coming soon", "info")}
                >
                  📄 Export
                </button>
                <button
